      ...
      <div class="max-w-5xl mx-auto flex flex-wrap p-5 flex-col md:flex-row">
        ...
        >
          <div class="md:ml-auto md:mr-auto font-4 pt-1 md:pl-14 pl-1 flex flex-wrap items-center md:text-base text-1xl md:justify-center justify-items-start">
            <a href="#about"class="mr-11 pr-2 cursor-pointer text-gray-300 hover:text-white font-semibold tr04">
              About Us
            </a>
            <div className="relative">
              ...
              >
                <span className="tr04">Explore</span>
                <svg
                  className={
                    flyer === true
                  ...
                  <div className="relative grid gap-6 bg-black px-2 py-6 sm:gap-8 ">
                    ...
                    >
                      <div className="ml-4">
                        ...
                        <p className="mt-1 text-sm text-gray-500">
                          Book a session and lets build your dream website to life
                        </p>
                      </div>
                    </a>
                  </div>
            ...
            <a href="#pricing"class="mr-12 md:ml-11 ml-0 cursor-pointer text-gray-300 hover:text-white font-semibold tr04">
              Pricing
            </a>
          ...
          <a
            data-v-54e46119=""
            href="https://github.com/developers-onboard"
            rel="noopener noreferrer"
            target="_blank"
